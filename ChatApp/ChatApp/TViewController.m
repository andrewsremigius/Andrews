...
-(void)getVoteQues:(NSString*)constraint
{
    self.key = constraint;
//    PFQuery *query = [PFQuery queryWithClassName:@"voteQues"];
//    [query whereKey:@"ansType" equalTo:constraint];
//    self.textKey = @"ansType";
...
//{
//    // Set frame here
////    label.frame = CGRectMake(10, 10, 320, 50);
...
//    [self.tableView setFrame:CGRectMake(0.0, 100.0, 320.0, 250.0)];
}
...
- (void)objectsDidLoad:(NSError *)error {
 ...
 query.cachePolicy = kPFCachePolicyCacheThenNetwork;
     ...
     if([self.key isEqualToString:@"57"])
     {
